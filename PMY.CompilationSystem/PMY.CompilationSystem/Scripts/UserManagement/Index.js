...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#tb_user').bootstrapTable({
            url: '/UserManagement/GetUsers',         //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
...
var ButtonInit = function () {
    ...
    oInit.Init = function () {
        ...
        $("#btn_edituser").click(function () {
            var arrselections = $("#tb_user").bootstrapTable('getSelections', function (row) { return row;});
        ...
        $("#btn_submituser").click(function () {
            ...
            postdata.Right = $("#txt_Right").val();
            $.ajax({
                type: "post",
                url: "/UserManagement/AddOrEdit",
                dataType: 'json',
                data: { users: postdata},
                success: function (data, status) {
                    if (status == "success" && data.Result == 1) {
